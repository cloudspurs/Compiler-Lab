 ...
 * macros to CompilerFlexLexer. However we change the context of the generated
 * yylex() function to be contained within the Scanner class. This is required
 * because the yylex() defined in CompilerFlexLexer has no parameters. */
class Scanner : public CompilerFlexLexer
{
public:
